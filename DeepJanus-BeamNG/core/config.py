class Config:
    ...
    def __init__(self):
        self.experiment_name = 'exp_5nodes'
        self.fitness_weights = (1.0, -1.0)

        self.POPSIZE = 12
        self.NUM_GENERATIONS = 150

        self.RESEED_UPPER_BOUND = int(self.POPSIZE * 0.1) + 1

        self.ARCHIVE_THRESHOLD = 8.0
        self.K_SD = 0.1

        #self.simulation_save = True
        self.simulation_save = False
        self.simulation_name = 'beamng_nvidia_runner/sim_$(id)'

        self.keras_model_file = 'self-driving-car-4600.h5'
        #self.keras_model_file = 'self-driving-car-039.h5'
